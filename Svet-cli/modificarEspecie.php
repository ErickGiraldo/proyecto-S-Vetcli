...
<br>
 <form class="form-inline" action="actualizarEspecie.php" method="POST" id="contact_form">
<div class="col-md-12 col-md-offset-0">  
<div>
        <h2  class="well well-sm" style="background-color: #000; text-align: center; border: none; "><font face="Cooper Black" color="#fff">Modificaión de Especie</font></h2>
</div>
  <center>     
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input type="text" class="form-control" name="nomEspecie" id="especie" value="<?php echo $reg['nomEspecie'];?>" >
        <input type="hidden" class="form-control" name="idEspecie" value="<?php echo $reg['idEspecie']; ?>">
</div>
</div>
</center> 
<br>
    <div class="footer" align="center">
       ...
       <a href="tablaEspecie.php"><button type="button" class="btn btn-danger">Cancelar <span class="glyphicon glyphicon-remove"> </span></button></a>
