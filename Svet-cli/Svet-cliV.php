...
<html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/Sdemo.css" />
        <link rel="stylesheet" type="text/css" href="../css/Sstyle2.css" />
		<script type="text/javascript" src="../js/Smodernizr.custom.86080.js"></script>
    </head>
...
-webkit-text-stroke: 3px normal;
        ...
        <div class="container">
            ...
            <div class="codrops-top">
                <a href="escritorioVeterinario.php">
            ...
            <header>
                <header>
                <h1><img src="../imagenes/Svet-cli.PNG"></h1>
                ...
                <div align="justify" ><h2><p><font size="5"> 
                       ...
                       <h1><img src="../imagenes/asmaxi.PNG" width="10%" ></h1>
