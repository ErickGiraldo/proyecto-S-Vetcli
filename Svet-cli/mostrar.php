...
<a href="escritorioauxiliar.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"> </span></button></a> 
     ...
     <form  class="form-inline"  method="POST" action="historiaClinica.php">
...
<center>
  ...
  <div class=" col-md-10 input-group
    <label class="form-control"></label> 
     <select name="tipoDocu" class="form-control" required> 
                   <?php  
...
<br>
  ...
  <div class="inputGroupContainer">
    ...
    <input type="text" name="fecha" class="form-control" style="width: 82%;" placeholder="AA-MM-DD" required>
  </div>  
<div class="footer" align="center">
    <button type="submit" class="btn btn-info">Ver Historia clinica <span class="glyphicon glyphicon-eye-open"> </span></button>
              </form>
<?php
           }else{
            echo "<script>alert('usuario no registrado');location.href ='javascript:history.back()';</script>";
          }
           }else{
