...
<!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div>
        <h2  class="well well-sm" style="background-color: #000; text-align: center; border: none;"><font size="10" face="Cooper Black" color="#fff">Escritorio Veterinario	</font></h2>
    </div>
    </div>
			...
			<div class="container">	
				<ul class="ch-grid">
					<li>
						 <h1><font size="5" color="#000000" face="Cooper Black"><center>Agregar nuevo chequeo</center></font></h1>
						<div class="ch-item">	
							<div class="ch-info">
								<h3><font size="4" color="#000000" face="Cooper Black"><center>Agregar nuevo chequeo</center></font></h3>
								<p><a href="consultar.php">Ver</a></p>
							</div>
							<div class="ch-thumb ch-img-1"></div>
						</div>
					</li>
					<li>
					 <h1><font size="5" color="#000000" face="Cooper Black"><center>Ver Historia Clinica</center></font></h1>
						<div class="ch-item">
							<div class="ch-info">
								<h3><font size="4" color="#000000" face="Cooper Black"><center>Ver Historia Clinica</center></font></h3>
								<p><a href="">Ver</a></p>
							</div>
					...
					<li>
					<h1><font size="5" color="#000000" face="Cooper Black"><center>Registrar Nuevo Usuario</center></font></h1>
						<div class="ch-item">	
							<div class="ch-info">
								<h3><font size="4" color="#000000" face="Cooper Black"><center>Registrar Nuevo Usario</center></font></h3>
								<p><a href="Registro.php">Ver</a></p>
							</div>
			...
			<div class="component">
				...
				<div class="cn-wrapper" id="cn-wrapper">
					<ul>
						...
						<li><a href="AdministracionV.php"><span>Reportes</span></a></li>
						<li><a href="Svet-cliV.php"><span>Svet-cli</span></a></li>
						<li></li>
						<li></li><
					 </ul>
				</div>
